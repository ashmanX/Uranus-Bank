...
Partial Class loantable
    ...
    Private Sub InitializeComponent()
        ...
        DataGridView1.Location = New Point(84, 218)
        ...
        loanbtn.Location = New Point(705, 805)
        loanbtn.Name = "loanbtn"
        loanbtn.Size = New Size(413, 105)
        loanbtn.TabIndex = 12
        loanbtn.Text = "Manage Loans"
        ...
        Label1.Location = New Point(800, 30)
        Label1.Name = "Label1"
        Label1.Size = New Size(195, 78)
        Label1.TabIndex = 11
        Label1.Text = "Loans"' 
        ' loantable
        ' 
